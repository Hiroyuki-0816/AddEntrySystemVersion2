	...
	<form method="get" action="/AddEntrySystemVersion2/Search01">
		...
		<table border="1">
			<tr>
				...
				<td><input id="idfrom" type="text" name="idfrom" size="8">~<input
					id="idto" type="text" name="idto" size="8"></td>
			</tr>
			...
			<tr>
				...
				<td><input id="agefrom" type="text" name="agefrom" size=3>~<input
					id="ageto" type="text" name="ageto" size=3></td>
